            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Grade Name <span
                                        class="text-danger">*</span> </label>
                            <div class="col-md-8">
                                <input type="text" name="grade_name" id="grade_name"
                                       class="form-control"/>
                                <span class="text-danger" id="error_grade_name"></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="button_action" id="button_action" value="Add" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm"
                            id="ok_button" name="ok_button">OK</button>
                    <button type="button" class="btn btn-danger btn-sm"
                            id="delete_button" data-dismiss="modal" name="delete_button">CLOSE</button>
                </div>
            </div>
        </form>
    </div>
